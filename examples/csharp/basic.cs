...
{
    class ContentFilterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/contentfilter";

        /// <summary>
        /// Make a POST request to the Content Filter API
        /// </summary>
        static async Task<JsonDocument> CallContentFilterAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { url &#x3D; &quot;https://www.pornhub.com/video/123&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Content Filter API...\n");

            var result = await CallContentFilterAPI();
