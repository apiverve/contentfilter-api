...
namespace APIVerve\Contentfilter;
...
/**
 * Client for the Content Filter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/contentfilter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/contentfilter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ContentfilterClient] {$message}\n";
        }
    }
}
