...
```java
import com.apiverve.contentfilter.ContentFilterAPIClient;
import com.apiverve.contentfilter.APIResponse;
import com.apiverve.contentfilter.APIException;

// Initialize the client
ContentFilterAPIClient client = new ContentFilterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/contentfilter](https://docs.apiverve.com/ref/contentfilter)
...
- **Documentation:** [https://docs.apiverve.com/ref/contentfilter](https://docs.apiverve.com/ref/contentfilter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/contentfilter-api/issues)
