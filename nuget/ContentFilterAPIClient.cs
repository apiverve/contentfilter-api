...
namespace APIVerve.API.ContentFilter
{
    ...
    /// <summary>
    /// Client for the ContentFilter API
    /// </summary>
    public class ContentFilterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/contentfilter";
        ...
        public ContentFilterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ContentFilterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ContentFilterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ContentFilterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ContentFilterQueryOptions options)
        {
        ...
        public ResponseObj Execute(ContentFilterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ContentFilterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ContentFilterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ContentFilterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ContentFilterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ContentFilterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ContentFilterQueryOptions options)
        {
